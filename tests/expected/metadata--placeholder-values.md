...
Some CMSes leave unresolved template literals like the ones in this page's meta tags. Domdown should skip over these and fall back to the next valid source.
