...
When the author display name is empty, some CMSes emit a literal ".." in every metadata surface. Domdown should treat this as no author rather than returning the placeholder verbatim.